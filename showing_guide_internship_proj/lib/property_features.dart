...
class PropertyHistoryWidget extends StatefulWidget {
  const PropertyHistoryWidget({Key? key}) : super(key: key);

  @override
  _PropertyHistoryWidgetState createState() => _PropertyHistoryWidgetState();
}
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Icon(Icons.av_timer_outlined,color: Colors.black,),
                      ),
                      Padding(
